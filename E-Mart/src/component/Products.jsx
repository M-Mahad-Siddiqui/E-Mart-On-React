...
//     useEffect(() => {
//         let componentMounted = true;  // Declare inside useEffect
...
//                     if (componentMounted) { // Only update state if component is still mounted
//                         setData(await response.clone().json());
//                         setFilter(await response.json());  // Assuming you want to set the same data to filter
...
//         return () => {
//             componentMounted = false;  // Cleanup on component unmount
//         };
//     }, []);
                    ...
                    <div className = "row">
                            {loading ? (
                                ...
                                filter.map((product) => (
                                    ...
                                    <h5     className = 'card-title mb-0'>{product.title.substring(0, 12)}...</h5>
                                    <p      className = 'card-text lead fw-bold'>${product.price}</p>
                                    <NavLink to = {'/product/${product.id}'} className = 'btn btn-outline-dark'>Add to cart</NavLink>
                                            </div>
                                        </div>
                                    </div>
                                ))
